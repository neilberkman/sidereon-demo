...
const CAP_CARDS: [string, string][] = [
  ...
  ["CLOCK STABILITY", "Allan-family frequency stability for receiver and reference clocks: overlapping and modified Allan deviation, Hadamard deviation, and time deviation, per IEEE-1139."],
